//Manual deployment of the upgrade contract
...
async function main(){
    ...
    //The upgrade function is from the ProxyAdmin contract, needs a proxycontract & an address
    const upgradeTx = await BoxProxyAdmin.upgrade(transparentProxy.address, boxV2.address)
    await upgradeTx.wait(1)

    //With this, ethers know all the functions in BoxV2. proxybox has the ABI of BoxV2
